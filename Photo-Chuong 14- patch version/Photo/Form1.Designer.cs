namespace Photo
{
    partial class frMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.flybyProvider = new Manning.PhotoControl.FlybyTextProvider(this.components);
            ...
            // mnuNew
            // 
            this.flybyProvider.SetFlybyText(this.mnuNew, null);
            ...
            // mnuOpen
            // 
            this.flybyProvider.SetFlybyText(this.mnuOpen, null);
            ...
            // mnuSave
            // 
            this.flybyProvider.SetFlybyText(this.mnuSave, null);
            ...
            // mnuSaveAs
            // 
            this.flybyProvider.SetFlybyText(this.mnuSaveAs, null);
            ...
            // mnuPrint
            // 
            this.flybyProvider.SetFlybyText(this.mnuPrint, null);
            ...
            // mnuPrintPreview
            // 
            this.flybyProvider.SetFlybyText(this.mnuPrintPreview, null);
            ...
            // mnuExit
            // 
            this.flybyProvider.SetFlybyText(this.mnuExit, null);
            ...
            // mnuCut
            // 
            this.flybyProvider.SetFlybyText(this.mnuCut, null);
            ...
            // mnuCopy
            // 
            this.flybyProvider.SetFlybyText(this.mnuCopy, null);
            ...
            // mnuPaste
            // 
            this.flybyProvider.SetFlybyText(this.mnuPaste, null);
            ...
            // mnuAbout
            // 
            this.flybyProvider.SetFlybyText(this.mnuAbout, null);
            ...
            // toolStripMenuItem1
            // 
            this.flybyProvider.SetFlybyText(this.toolStripMenuItem1, null);
        ...
        private Manning.PhotoControl.FlybyTextProvider flybyProvider;
    }
}
